...
#------------------[ LOGO-LAKNAT ]-----------------#
def banner():
	print(f'''\t{asu}                                                                                 {m}•{k}•{h}•{sir} Author : NDRII-XD {x}{m}•{k}•{h}•{x}''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def login_lagi334():
	try:
		...
		print(f'  %s[%sx%s]%s LOGIN GAGAL.....CEK AKUN LU !!%s'%(x,k,x,m,x))
		exit()
def bot():
	try:
...
def menu(my_name,my_id):
	...
	cetak(nel('\tSelamat Datang [blue]%s[green] Ngentod'%(my_name)))
	print(f'└──[1] {sir}ID KAMU {x}  : '+str(my_id))
	print(f'└──[1] {sir}IP KAMU {x}  : {ip}')
	print('-----------------------------------------------------------------------------|')
	print(f'└──[1] {sir} CRACK PUBLIK MASSAL {x} ')
	print(f'└──[2] {sir}{b} CRACK FOLLOWERS {x} ')
	print(f'└──[3] {sir} CRACK GRUB {x}   ')
	print(f'└──[4] {sir}{b} CRACK FILE {x}	')
	print(f'└──[5] {sir} HASIL CRACK GANS {x} ')
	print(f'└──[0] {k} KELUAR {x}   ')
	print('-----------------------------------------------------------------------------|')
	...
	if _____alvino__adijaya_____ in ['1']:
		...
		print(f'└──[◉] {k}ANDA MEMILIH YG SALAH {x} ')
		back()
def error():
	print(f'└──[◉] {k}MAAF GAN FITURNYA MAINTENANCE  {x}')
	time.sleep(4)
	back()
#-----------------[ HASIL-CRACK ]-----------------#
def result():
	...
	if kz in ['2']:
		...
		if len(vin)==0:
			...
			for cpku in range(len(lin)):
				...
				print(f'{x}└──[CP]{k}{cpkuni[0]}|{cpkuni[1]}')
				nocp +=1
			print('')
		...
		if len(vin)==0:
			...
			try:geh = lol[geeh]
				...
				print('└──[😡]Pilih Yang Bener Anjengg ')
				back()
			...
			for cpku in range(len(lin)):
				cpkuni=lin[nocp].split('|')
				print('')
				print(f'{x}└──[OK]{h}{cpkuni[0]}|{cpkuni[1]}|{cpkuni[2]}')
				nocp +=1
			print('')
			input(f'{x}[{m} Klik Enter{x} ]')
			back()
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input('└──[🤘]MAU INPUT BERAPA TARGET ? : '))
	except ValueError:
	...
	try:
		print('')
		print(f'└──[ID]Total Idz Yang Terkumpul🔥{h}'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
...
#-------------[ CRACK-FROM-FILE ]------------------#
def crack_file():
	try:vin = os.listdir('/sdcard/NDRII-DUMP')
	except FileNotFoundError:
	...
	if len(vin)==0:
		...
		lol = {}
		for isi in vin:
			try:hem = open('/sdcard/NDRII-DUMP/'+isi,'r').readlines()
			except:continue
			cih+=1
			if cih<100:
				nom = ''+str(cih)
		...
		try:geh = lol[geeh]
			...
			time.sleep(3)
			back()
		try:lin = open('/sdcard/NDRII-DUMP/'+geh,'r').read().splitlines()
		except:
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	print(f'{x}└──[1] {sir}AKUN OLD{x} ')
	print(f'└──[2] {sir}AKUN NEW{x} ')
	print(f'└──[3] {sir}AKUN RANDOM{x} ')
	print('')
	hu = input('└──[4] {sir}PILIH{x} : ')
	if hu in ['1','01']:
		...
		print(f'└──[◉]PILIH YG BENER ')
		exit()
	print('-----------------------------------------------------------------------------|')
	print(f'└──[1] {sir}MOBILE{x}')
	#print(f'└──[2] {sir}MBASIC{x}')
	#print(f'└──[3] {sir}TOUCH{x}  ')
	#print(f'└──[4] {sir}MTOUCH{x} ')
	print('-----------------------------------------------------------------------------|')
	hc = input(f'└──[◉] {sir}Pilih :{x} ')
	print('-----------------------------------------------------------------------------|')
	if hc in ['1','01']:
		...
		method.append('mobile')
	print('-----------------------------------------------------------------------------|')
	_jembot_ = input(f'└──[APK] {sir}TAMBAHKAN APLIKASI( Y/t ) {x} ')
	if _jembot_ in ['']:
		print('└──[😡]Pilih Yang Bener Kontol ')
		back()
		...
		taplikasi.append('no')
	print('-----------------------------------------------------------------------------|')
	pwplus=input(f'└──[PW] {sir}Tambahkan Password Manual ( Y/t ){x} ')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
		cetak(nel('[[cyan]•[white]] Masukkan Katasandi Tambahan Minimal 6 Karakter\n[[cyan]•[white]] Contoh :[green] kakak,ngentod,adik[white] '))
		pwku=input(f'└──[PW] {sir}Masukkan Password Tambahan : {x}')
		pwkuh=pwku.split(',')
		for xpw in pwkuh:
			pwnya.append(xpw)
	else:
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	print(f'{m}•{k}•{h}•{x} SEDANG MENGCRACK ID {m}•{k}•{h}•{x}')
	print('-----------------------------------------------------------------------------|')
	print(f'└──[OK]{sir}HASIL{x}{h}OK{x}{sir} TRSIMPAN DI{x} : {h}OK/%s {x}'%(okc))
	print('-----------------------------------------------------------------------------|')
	print(f'└──[CP]{sir}HASIL{x} {k}CP{x}{sir} TERSIMPAN DI : {k}CP/%s {x}'%(cpc))
	print('-----------------------------------------------------------------------------|')
	print(f'└──[✈️] {sir}MAINKAN MODE PESAWAT SETIAP{x} {m}1k{x} Idz\n')
	print('-----------------------------------------------------------------------------|')
...
if __name__=='__main__':
	...
	try:os.mkdir('/sdcard/NDRII-DUMP')
	except:pass
	...
	alvino_xy(f'\n\t{x}——> {h}AWOKAWOK\n\t{x}——> {h}Cieee Crackkk\n\t{x}——> {h} Bismillah dapet OK\n\t{x}——> {h}Gak Dapet CP Mulu\n\t{x}——> {h}Semoga Harimu Menyenangkan{x}')
	time.sleep(3)
	login()
